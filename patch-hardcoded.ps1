...
$replacements = @{
    ...
    "Probe ok" = "探测正常"
    "Accounts" = "账户"
    "Unsupported schema node. Use Raw mode." = "不支持的架构节点。使用原始模式。"
    "Ack Reaction" = "确认回复"
    "Allow From" = "允许来源"
    "No items yet. Click Add to create one." = "暂无项目。点击添加创建一个。"
    "Block Streaming" = "阻止流式传输"
    ...
    "Reaction Level" = "回复级别"
    "Reaction Notifications" = "回复通知"
    "Reply To Mode" = "回复模式"
    "Response Prefix" = "响应前缀"
    "Retry" = "重试"
    "Telegram Streaming Mode" = "Telegram 流式传输模式"
    "Stream Mode" = "流模式"
